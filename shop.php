...
?>
        ...
        <section id="product_sec">
            <div class="shop-page-area pt-100 pb-100 shop_top">
                <div class="container">
                    ...
                    <div class="row flex-row-reverse">
                        <div class="col-lg-9">
                            ...
                            <?php
                                ...
                                $product_sql.=" order by RAND(dish_id) desc";
                                $product_res=mysqli_query($con,$product_sql);
                                $product_count=mysqli_num_rows($product_res);
                            ?>
                            <div class="grid-list-product-wrapper shop-area">
                                        ...
                                        <ul id="faq" class="category_list">
                                            ...
                                            while($cat_row=mysqli_fetch_assoc($cat_res)){
                                                ...
                                                if($cat_id==$cat_row['category_id']){
                                                    echo "<li class='active'><input type='hidden' value=".$cat_row['category_id']."><a href='shop.php?cat_id=".$cat_row['category_id']."'>".$cat_row['category']."</a></li>";
                                                }
                                                else{
