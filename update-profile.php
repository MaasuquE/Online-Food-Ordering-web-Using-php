                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img id="img" src="admin/upload/<?php echo $row['image']; ?>" alt=""/>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <div class="row pass_btn">
                                                ...
                                                <div class="col-md-6">
                                                    <button type="button"  onclick="change_pass('<?php echo $row['id']; ?>')">Change Password</button>
                                                </div>
                                            </div>
                                </div>
                            </div>
                            <div class="pass_change profile-tab" id="change_pass">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" id="pass_chk_id" value="<?php echo $_SESSION['user_id'];?>" >
                                        <br><span class="field_error" id="old_error"></span>
                                    </div>
                                </div>
                                <div id="new_pass_chk">
                                    <div class="row" >
